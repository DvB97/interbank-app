...
import { SuperejecutiveMapPage } from "../superejecutive-map/superejecutive-map";
import { LoadingController } from "ionic-angular";
import { ApiProvider } from "../../providers/api/api";
import { Geolocation, Geoposition } from "@ionic-native/geolocation";
import { BarcodeScanner } from "@ionic-native/barcode-scanner";
/**
 * Generated class for the SuperejecutiveSearchPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-superejecutive-search',
  templateUrl: 'superejecutive-search.html',
})
export class SuperejecutiveSearchPage {
  classIcon: any;
  ...
  searchMapa() {
    console.log("Entro");
    this.navCtrl.push(SuperejecutiveMapPage);
  }
  getPosition(): any {
    this.geolocation
      .getCurrentPosition()
